...
//     );
//     await handicapBetContract
//       .connect(b1)
//       .acceptHandicapBet(betId, 2, { value: parseUnits("10", 18) });
...
//     console.log(
//       parseFloat(
//         (await provider.getBalance(vaultContract.address)).toString()
//       ) / 1e18
//     );
//   });
...
//   //     (await handicapBetContract.getLastHandicapBets(10))[0].id
//   //   );
//   //   await handicapBetContract.connect(b1).acceptHandicapBet(betId, 2);
//   //   await handicapBetContract.resolveHandicapBet(betId);
//   //   console.log(
//   //     "home: ",
